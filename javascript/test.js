let findLetterFrequency = require("./letter_frequency").findLetterFrequency;
...
let frequencies = findLetterFrequency(text);

console.log("For the text: \n");
console.log(text);
console.log("\n----------LETTER FREQUENCIES----------\n")
for (k of Object.keys(frequencies)) {
    console.log("" + k + ": %" + (frequencies[k] * 100).toPrecision(5))
}